[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=8661452&assignment_repo_type=AssignmentRepo)
...
typedef struct Elm Elm;    // Elm struct dotor Elm nertei buttsen torliin huvisagch zarlah
```
...
```
`top` хаяган хувьсагч үргэлж хамгийн сүүлд орсон элемент бүтцийн хаяг, 
`len` нь хэдэн элемент стакт хадгалагдаж байгааг заана.
 Харин стакт орох `Elm` бүтцүүдийн хувьд `x` нь оруулсан тоог хадгалах бол `next` нь өмнөх элементийнхээ хаягийг хадгалах ёстой.
